        ...
        AcordionA(tipo="a" clase-tarjeta="tarjeta color-secundario")
          .row(titulo="Ley 527 de 1999")
            .col-md-12.mb-4.mb-md-0
              p Define y reglamenta el acceso y uso de los mensajes de datos, brindando igualdad de condiciones en un litigio o discusión jurídica.
        
          .row(titulo="Ley 594 de 2000")
            .col-md-12.mb-4.mb-md-0
              p Ley General de Archivos. Define y reglamenta el acceso y uso de los mensajes de datos, del comercio electrónico y de las firmas digitales.

          .row(titulo="Ley 872 de 2003")
            .col-md-12.mb-4.mb-md-0
              p Exige a las entidades públicas, implementar sistemas de gestión de la calidad, donde se evidencie un proceso de gestión documental.

          .row(titulo="Ley 1437 de 2011")
            .col-md-12.mb-4.mb-md-0
              p Establece la utilización de medios electrónicos en el proceso administrativo, en lo referente al documento público en medios electrónicos, el archivo electrónico de documentos, el expediente electrónico, la recepción de documentos electrónicos por parte de las autoridades. 
          
          .row(titulo="Ley 1712 de 2014")
            .col-md-12.mb-4.mb-md-0
              p Regula el derecho de acceso a la información pública, los procedimientos para el ejercicio y garantía del derecho y las excepciones a la publicidad de información.
          
          .row(titulo="Decreto 2126 de 2012")
            .col-md-12.mb-4.mb-md-0
              p Modifica la estructura del Archivo General de la Nación y se determina como eje de la modernización de la política archivística del Estado colombiano.
        
          .row(titulo="Decreto 1515 de 2013")
            .col-md-12.mb-4.mb-md-0
              p Por el cual se reglamenta la Ley 80 de 1989.

          .row(titulo="Decreto 029 de 2015")
            .col-md-12.mb-4.mb-md-0
              p Por medio del cual se reglamenta el proceso de entrega y/o transferencia de los archivos públicos de las entidades que se suprimen, fusionen, privaticen o liquiden.
      ...
      .col-lg-11
        .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-4.mb-4
          ...
          .bloque-texto-g__texto.p-4
            p Ahora, en la realización de documentos con enfoque organizacional, se deben tener presente algunos modelos previamente estructurados que definan la intención de lo que se pretenda, el desarrollo de un objetivo planteado o una competencia formulada, a través de una estandarización que diseña la alta dirección, siendo homogénea la estructura del formato con los parámetros de la información que se requiere; estos formatos deben estar alineados con los sistemas de gestión que maneje la entidad.
    
    p.mb-4 Estos tipos de documentos, pueden estar clasificados según el nivel del proceso y de gestión dentro de la organización, como aquellos que son para la toma de decisiones, planeación, operacionalización o funcionamiento interno de la entidad, transmisión o mandatorio, de registro de instancias y de comunicación interna y externa.      
